...
! function (e) {
    ...
    ! function (t) {
        ...
        var t, o = "mCustomScrollbar",
            ...
            O = function (t) {
                var o = t.type,
                    a = t.target.ownerDocument !== document ? [(e(frameElement).offset() != undefined ? e(frameElement).offset().top : 0), (e(frameElement).offset() != undefined ? e(frameElement).offset().left : 0)] : null,
                    n = W() && t.target.ownerDocument !== top.document ? [(e(t.view.frameElement).offset() != undefined ? e(t.view.frameElement).offset().top : 0),(e(t.view.frameElement).offset() != undefined ? e(t.view.frameElement).offset().left : 0)] : [0, 0];
                switch (o) {
                    case "pointerdown":
                    case "MSPointerDown":
                    case "pointermove":
            ...
            te = function (e) {
                ...
                return [(e.offset()!=undefined?e.offset().top:0) - t.offset().top, e.offset().left - t.offset().left]
            },
            oe = function () {
                function e() {
